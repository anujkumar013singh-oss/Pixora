...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen bg-[#05050a] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-cyan-950/30 via-[#05050a] to-blue-950/20" />
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_70%_20%,_var(--tw-gradient-stops))] from-cyan-600/10 via-transparent to-transparent" />
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_30%_80%,_var(--tw-gradient-stops))] from-blue-600/8 via-transparent to-transparent" />
      ...
      />
      <motion.div
        className="absolute bottom-1/4 -left-40 w-[400px] h-[400px] rounded-full opacity-10"
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-7">
            ...
            <div className="relative">
              ...
              />
              <p className="mt-1.5 text-xs text-zinc-600" style={{ fontFamily: "'Cabin', sans-serif" }}>
